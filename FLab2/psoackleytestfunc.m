function [fitVal,varargout] = psoackleytestfunc(xVec,params)
% A benchmark test function for CRCBPSO
% F = PSOACKLEYTESTFUNC(X,P)
% Compute the Ackley fitness function for each row of X. The fitness
...
% actual coordinate values before computing fitness: 
