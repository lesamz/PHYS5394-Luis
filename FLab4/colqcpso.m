function outResults = colqcpso(inParams,psoParams,nRuns)
...
% the number of independent PSO runs. The output is returned in the struct O
% The fields of I are:
...
% 'psdY': values of the colored noise PSD
% 'psdX': frequencies of the PSD
...
% Modified from Soumya D. Mohanty, May 2018
...
for lpruns = 1:nRuns   
    ...
    [templateVec,~] = normsig4psd(estSig,inParams.sampFreq,inParams.psdY,1);
    % Calculate the amplitude as the inner product of data with template
    estAmp = innerprodpsd(inParams.dataY,templateVec,inParams.sampFreq,inParams.psdY);
