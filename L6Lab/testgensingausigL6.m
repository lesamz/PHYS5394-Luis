...
[specFT,specFreq,specTime] = spectrogram(sigVec,winSmpls,ovrlpSmpls,[],samplFreq(1));
...
xlabel('Time [s]','FontUnits','points','Interpreter','latex','FontSize',18,'FontName','Times');
title(sprintf('Sine-Gaussian signal Spectrogram'),'Interpreter','latex','FontSize',20);
colormap turbo;
colorbar;
